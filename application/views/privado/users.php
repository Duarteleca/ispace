...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-6 col-md-6">
            <a href="<?php echo base_url('Registo')?>" data-placement="top" data-toggle="tooltip" title="Insert">
                <button class="btn btn-info" data-title="Insert" data-toggle="modal" data-target="#insert">Inserir novo Utilizador</span>
                </button>
            </a>
    ...
    <table name="tabelaequipamentos" id="example" class="table table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <img id="imagem" class="imagem_logo" height="60px" width="60px" src="<?php echo base_url($row['imagem'])?>"> </td>
                <td>
                    <?php echo $row['nome'] ?>
                </td>
                <td>
                ...
                <!-- Modal Edit-->
                <div class="modal fade" id="myModaleditar<?php echo $id_utilizador;?>" tabindex="-1" role="dialog" aria-labelledby="edit"
                    aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input class="form-control " type="hidden" name="id_user" id="id_tiposala" value=" <?php echo $id_utilizador; ?>">
                                </div>
                                <div class="form-group">
